...
pub struct EventInstance6Object {
    pub title: String,
...
pub struct EventInstanceCreateInput6 {
    title: String,
    description: String,
...
pub fn event_instances6() -> EventInstance6Object {
    EventInstance6Object {
        title: "a".to_string(),
        description: "a".to_string(),
        from_date: Utc::now(),
        to_date: Utc::now(),
        start_transition_mins: 6,
