...
pub struct EventInstance9Object {
    pub title: String,
...
pub struct EventInstanceCreateInput9 {
    title: String,
    description: String,
...
pub fn event_instances9() -> EventInstance9Object {
    EventInstance9Object {
        title: "a".to_string(),
        description: "a".to_string(),
        from_date: Utc::now(),
        to_date: Utc::now(),
        start_transition_mins: 9,
